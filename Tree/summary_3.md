###  题目1：144. Binary Tree Preorder Traversal
...
def preorderTraversal(self, root):
    ...
    return ans
```
###  题目2：145. Binary Tree Postorder Traversal
...
def postorderTraversal(self, root):
    ...
    return ans
```
###  题目3：173. Binary Search Tree Iterator【持续研究中…】
...
###  题目4：199. Binary Tree Right Side View
...
###  题目5：222. Count Complete Tree Nodes
...
def invertTree(self, root):
    ...
    return root
```
###  题目7：230. Kth Smallest Element in a BST
...
###  题目8：235. Lowest Common Ancestor of a Binary Search Tree
...
def lowestCommonAncestor(self, root, p, q):
    ...
    while True:
        ...
        if cur_node.val > max_num:
            ...
            return cur_node
```
### 题目9：236. Lowest Common Ancestor of a Binary Tree
